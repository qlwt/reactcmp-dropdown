...
import { useListPosApiFixed } from "#src/hook/listpos/api/fixed.js"
...
import { prop_clmap_def_listfix } from "#src/util/prop/clmap/def/listfix.js"
...
export const CmpListFix = r.memo(r.forwardRef<HTMLDivElement, CmpListFix_Props>((props, f_ref) => {
    ...
    const ref = useRefMerge<HTMLDivElement>(l_ref, f_ref)
